...
import { AlertTriangle, CheckCircle2, Clock, Receipt, Building2, FileDown, FileSpreadsheet, TrendingUp, TrendingDown, CalendarClock } from "lucide-react";
...
const Acompanhamento = () => {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      const [empRes, ctRes, fatRes] = await Promise.all([
  ...
  // Check which contracts need billing for the current period
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Visão completa de faturamento, vencimentos e alertas por empresa</p>
          </div>
